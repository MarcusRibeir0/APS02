...
public class Lixeiro {
	...
	/**
		* Método utilizado para pegar um ponto do corpo do jogador
		* @param indice Índice do corpo a ser retornado
		*/
	public Point getCorpo(int indice) {
		Point point = new Point(x[indice], y[indice]);
		return point;
	}
