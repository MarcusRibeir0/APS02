...
public class TelaDoMenu extends JFrame implements ActionListener {
	...
	public TelaDoMenu() {
		...
		PlayerLabel = new JLabel(new ImageIcon("src/res/PlayerLabel.png"));
		imagemLabel.add(PlayerLabel);

		PlayerField = new JTextField(10);
		imagemLabel.add(PlayerField);
		...
		PlayerLabel.setBounds(550, 510, 100, 30);
		PlayerField.setBounds(650, 510, 130, 30);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ((e.getSource() == jogarButton)) {
			...
			if (PlayerField.getText().trim().equals("")) {
				JOptionPane.showMessageDialog(null, "Por favor, Digite um nick!");
			} else {
				Main.player.setNome(PlayerField.getText());
